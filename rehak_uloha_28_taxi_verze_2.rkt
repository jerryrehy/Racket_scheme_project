...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname rehak_uloha_28_taxi_verze_2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
; --------------------------------------------------------------------------------------------------------------------------------------------------
;| Úloha č.28                                                                                                                                       |
; --------------------------------------------------------------------------------------------------------------------------------------------------
